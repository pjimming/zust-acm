...
func AddVultureDiskInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddVultureDiskInfoReq
		if err := httpx.Parse(r, &req); err != nil {
			httpresp.HttpError(w, r, errorx.NewCodeError(2, http.StatusBadRequest, err.Error()))
			return
		}

		l := vulturediskinfo.NewAddVultureDiskInfoLogic(r.Context(), svcCtx)
		err := l.AddVultureDiskInfo(&req)
